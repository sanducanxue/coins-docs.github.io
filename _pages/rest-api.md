...
[still in qa] This endpoint retrieves an existing transfer record if an id is provided. Otherwise, it will return a paginated list of transfers.
...
[still in qa] Transfer funds between two accounts
